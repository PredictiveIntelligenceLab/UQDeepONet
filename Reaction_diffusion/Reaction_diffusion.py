...
if __name__ == '__main__':
    ...
    class DataGenerator_batch(data.Dataset):
        def __init__(self, usol, u0_train, m = 100, P = 100,
    ...
    # Create data set
    batch_size = 512
    dataset = DataGenerator_batch(usol_train, u0_train, m, P, batch_size, N_ensemble)
    ...
    Predict_mu_save = onp.zeros((N_test, 100, 100)) # Store the predicted mean
    Predict_std_save = onp.zeros((N_test, 100, 100)) # Store the predicted std
